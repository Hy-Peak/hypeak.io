<template>
  <div v-if="false" :class="$style.icons">
    <div>
      <a-tooltip title="svg">
        <svg>
    ...
    >
      ...
      >
        ...
        <div style="min-height: 150px;">
          <div v-show="stepsControl.current === 0" style="height: 100%;">
            <a-textarea v-model:value="svgDomCode" style="height: 150px; resize: none"></a-textarea>
          </div>
        </div>
        <a-row :gutter="15" justify="end" style="margin-top: 1rem;">
          ...
          <a-col>
            <a-button type="primary" @click="nextHandle">NEXT</a-button>
          </a-col>
        </a-row>
      </a-card>
    </a-col>
